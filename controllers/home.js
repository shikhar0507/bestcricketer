app.controller('home', function ($scope, $location, $http, helper, service, chartService) {
  ...
  function isSelfish(mainData, parsed) {
    const indianGrounds = ["Kolkata", "Chennai", "Delhi", "Mumbai", "Kanpur", "Bangalore", "Mumbai", "Cuttack", "Mohali", "Visakhapatnam", "Hyderabad", "Indore", "Nagpur", "Pune", "Rajkot", "Ranchi", "Dharamshala", "Guwahati", "Thiruvananthapuram", "Dehradun", "Lucknow", "Greater Noida", "Mumbai", "Lucknow", "Hyderabad", "Chennai", "Nagpur", "Ahmedabad", "Jalandhar", "Amritsar", "Jaipur", "Srinagar", "Vadodara", "Ahmedabad", "Indore", "Jamshedpur", "Guwahati", "Delhi", "Thiruvananthapuram", "Pune", "Chandigarh", "Rajkot", "Faridabad", "Gwalior", "Visakhapatnam", "Margao", "Lucknow", "Patna", "Vadodara", "Kochi", "Jodhpur", "Vijayawada"]

    for (var v = 0; v < parsed.length; v++) {
      const index = indianGrounds.indexOf(mainData[v].ground);
      if (index > -1) {
        scoreInHome.push(v);
      } else {
        scoreInAway.push(v);
